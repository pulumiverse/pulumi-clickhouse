...
namespace Pulumiverse.Clickhouse.Inputs
{
    ...
    public sealed class ClickpipeDestinationGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("columns")]
        private InputList<Inputs.ClickpipeDestinationColumnGetArgs>? _columns;
        ...
        /// </summary>
        public InputList<Inputs.ClickpipeDestinationColumnGetArgs> Columns
        {
            get => _columns ?? (_columns = new InputList<Inputs.ClickpipeDestinationColumnGetArgs>());
            set => _columns = value;
        }
        ...
        public Input<Inputs.ClickpipeDestinationTableDefinitionGetArgs>? TableDefinition { get; set; }

        public ClickpipeDestinationGetArgs()
        {
        }
        public static new ClickpipeDestinationGetArgs Empty => new ClickpipeDestinationGetArgs();
    }
}
