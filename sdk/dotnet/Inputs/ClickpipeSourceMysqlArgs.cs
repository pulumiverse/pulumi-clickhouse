...
namespace Pulumiverse.Clickhouse.Inputs
{
    ...
    public sealed class ClickpipeSourceMysqlArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private Input<Inputs.ClickpipeSourceMysqlCredentialsArgs>? _credentials;
        ...
        /// </summary>
        public Input<Inputs.ClickpipeSourceMysqlCredentialsArgs>? Credentials
        {
            get => _credentials;
            set
            {
                var emptySecret = Output.CreateSecret(0);
                _credentials = Output.Tuple<Input<Inputs.ClickpipeSourceMysqlCredentialsArgs>?, int>(value, emptySecret).Apply(t => t.Item1);
            }
        }
        ...
        public Input<Inputs.ClickpipeSourceMysqlSettingsArgs> Settings { get; set; } = null!;
        ...
        private InputList<Inputs.ClickpipeSourceMysqlTableMappingArgs>? _tableMappings;

        /// <summary>
        /// Table mappings from MySQL source to ClickHouse destination.
        /// </summary>
        public InputList<Inputs.ClickpipeSourceMysqlTableMappingArgs> TableMappings
        {
            get => _tableMappings ?? (_tableMappings = new InputList<Inputs.ClickpipeSourceMysqlTableMappingArgs>());
        ...
        public ClickpipeSourceMysqlArgs()
        {
        }
        public static new ClickpipeSourceMysqlArgs Empty => new ClickpipeSourceMysqlArgs();
    }
}
