...
namespace Pulumiverse.Clickhouse.Inputs
{
    ...
    public sealed class ClickpipeSourceObjectStorageAccessKeyGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("accessKeyId")]
        ...
        public ClickpipeSourceObjectStorageAccessKeyGetArgs()
        {
        }
        public static new ClickpipeSourceObjectStorageAccessKeyGetArgs Empty => new ClickpipeSourceObjectStorageAccessKeyGetArgs();
    }
}
