...
namespace Pulumiverse.Clickhouse.Inputs
{
    ...
    public sealed class ClickpipeSourceObjectStorageArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Access key
        /// </summary>
        [Input("accessKey")]
        public Input<Inputs.ClickpipeSourceObjectStorageAccessKeyArgs>? AccessKey { get; set; }
        ...
        public ClickpipeSourceObjectStorageArgs()
        {
        }
        public static new ClickpipeSourceObjectStorageArgs Empty => new ClickpipeSourceObjectStorageArgs();
    }
}
