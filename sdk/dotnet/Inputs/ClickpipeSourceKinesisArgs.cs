...
namespace Pulumiverse.Clickhouse.Inputs
{
    ...
    public sealed class ClickpipeSourceKinesisArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The access key for the Kinesis source. Use with `IAM_USER` authentication. Can be rotated in place via an update.
        /// </summary>
        [Input("accessKey")]
        public Input<Inputs.ClickpipeSourceKinesisAccessKeyArgs>? AccessKey { get; set; }
        ...
        public ClickpipeSourceKinesisArgs()
        {
        }
        public static new ClickpipeSourceKinesisArgs Empty => new ClickpipeSourceKinesisArgs();
    }
}
