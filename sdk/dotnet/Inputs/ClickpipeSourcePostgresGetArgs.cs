...
namespace Pulumiverse.Clickhouse.Inputs
{
    ...
    public sealed class ClickpipeSourcePostgresGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private Input<Inputs.ClickpipeSourcePostgresCredentialsGetArgs>? _credentials;
        ...
        /// </summary>
        public Input<Inputs.ClickpipeSourcePostgresCredentialsGetArgs>? Credentials
        {
            get => _credentials;
            set
            {
                var emptySecret = Output.CreateSecret(0);
                _credentials = Output.Tuple<Input<Inputs.ClickpipeSourcePostgresCredentialsGetArgs>?, int>(value, emptySecret).Apply(t => t.Item1);
            }
        }
        ...
        public Input<Inputs.ClickpipeSourcePostgresSettingsGetArgs> Settings { get; set; } = null!;

        [Input("tableMappings", required: true)]
        private InputList<Inputs.ClickpipeSourcePostgresTableMappingGetArgs>? _tableMappings;

        /// <summary>
        /// Table mappings from Postgres source to ClickHouse destination.
        /// </summary>
        public InputList<Inputs.ClickpipeSourcePostgresTableMappingGetArgs> TableMappings
        {
            get => _tableMappings ?? (_tableMappings = new InputList<Inputs.ClickpipeSourcePostgresTableMappingGetArgs>());
        ...
        public ClickpipeSourcePostgresGetArgs()
        {
        }
        public static new ClickpipeSourcePostgresGetArgs Empty => new ClickpipeSourcePostgresGetArgs();
    }
}
