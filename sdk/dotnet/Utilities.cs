...
namespace Pulumiverse.Clickhouse
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pulumiverse/pulumi-clickhouse";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumiverse.Clickhouse.version.txt");
    ...
    internal sealed class ClickhouseResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ClickhouseResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
